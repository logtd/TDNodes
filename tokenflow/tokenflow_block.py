...
def make_tokenflow_block(model_class, n_cond=1, n_uncond=1):
    class TokenFlowBlock(model_class):
      def forward(
            self,
          hidden_states,
          context=None,
          ...
          if self.pivotal_pass:
              ...
              # setattr(self, 'pivot_idx', self.batch_idx)  
          else:
              # print('using pivot_idx', self.pivot_idx, 'with batch_idx', self.batch_idx)
              idx1 = []
              idx2 = [] 
