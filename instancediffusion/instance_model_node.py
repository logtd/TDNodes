...
folder_paths.folder_names_and_paths['InstanceDiffusion'] = os.path.join(
  folder_paths.models_dir, 'InstanceDiffusion')
...
class InstanceDiffusionLoaderNode:
  ...
  def load_instance_models(self, text):
    fusers_path = os.path.join(
      folder_paths.folder_names_and_paths['InstanceDiffusion'], 'fusers.ckpt')
    ...
    scaleu_path = os.path.join(
      folder_paths.folder_names_and_paths['InstanceDiffusion'], "scaleu.ckpt")
    ...
    position_net_path = os.path.join(
      folder_paths.folder_names_and_paths['InstanceDiffusion'], "position_net.ckpt")
